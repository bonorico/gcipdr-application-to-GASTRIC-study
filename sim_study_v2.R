## sim_study_v2.R contains R commands to execute 'gcipdr application to GASTRIC group meta-analysis' (from homonymous repository). 
...
### IT EXECUTES CODE TO PRODUCE TABLE 15 SM 
...
## simulation 2: frailty = 0.4 and ranefSD = 0.25
...
saveRDS(out, file.path( outfolder, "simul_2.rds"))  # in case you save results above

#  out <- readRDS(file.path( outfolder,"simul_2.rds"))       # in case you load already saved results 

# time plan : 24 h approx on 2 cores
...
##         out[[i]][[j]]$REG[, 8:9] <- out0[[i]][[j]]$REG[, 8:9]
...
##         out[[i]][[j]]$KM <- rbind(src, dst) ## replace whole slot
...
## run vae  23 h total block   on 3 cores
...
saveRDS(outVAE, file.path( outfolder, "simulVAE_2.rds"))   # in case you save results above

#  outVAE <- readRDS(file.path( outfolder, "simulVAE_2.rds")) # in case you load already saved results 
...
outReg[, 2] <-  rep( c("\\multirow{4}{4em}{50 (2)}", rep("", 3), "\\multirow{4}{4em}{500 (6)}", rep("", 3)), 3)
...
Ref <- c(
    c( prms[[1]]$b, outReg[2, 4], 0.25, 0.4),  
    c( prms[[1]]$b, outReg[6, 4], 0.25, 0.4),
    c( ref[[1]][1], outReg[10, 4], 0.25, 0.4),
    c( ref[[1]][2], outReg[14, 4], 0.25, 0.4),
    c( ref[[2]][1], outReg[18, 4], 0.25, 0.4),
    c( ref[[2]][2], outReg[22, 4], 0.25, 0.4)
)
...
outREG$Est <- factor(outReg$Est, labels = c("$\\beta$", "$\\xi$", "$\\tau$", "SD"))
...
saveRDS(outREG, file.path(outfolder, "torep_simul_2.rds") )
...
textsize <- theme_bw() + theme(axis.text = element_text(size=18), axis.title = element_text(size=20), strip.text.x = element_text(size = 19), strip.text.y = element_text(size = 19), legend.title= element_blank(), legend.text=element_text(size=18), legend.position="bottom" )
 ...
 pdf("kmSim_sidebyside_GCgam_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_GCgam_500_6_simul_2.eps", width = 10.4, height = 8.3)
...
pdf("kmSim_sidebyside_GCjohn_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_GCjohn_500_6_simul_2.eps", width = 10.4, height = 8.3)
...
#
pdf("kmSim_sidebyside_CART_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_CART_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 dev.off()
                                        ...
                                        #
pdf("kmSim_sidebyside_VAE_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_VAE_500_6_simul_2.eps", width = 10.4, height = 8.3)
...
pdf("kmSim_sidebyside_MA_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_MA_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 pdf("kmSim_sidebyside_IPDboot_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 pdf("kmSim_sidebyside_IPDboot_500_6_simul_2.eps", width = 10.4, height = 8.3)
...
pdf("kmSim_overlap_GCgam_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_GCgam_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 pdf("kmSim_overlap_GCjohn_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_GCjohn_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 pdf("kmSim_overlap_CART_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_CART_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 pdf("kmSim_overlap_VAE_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_VAE_500_6_simul_2.eps", width = 10.4, height = 8.3)
 ...
 pdf("kmSim_overlap_MA_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_MA_500_6_simul_2.eps", width = 10.4, height = 8.3)
...
dev.off()
                                        ...
                                        #
 pdf("kmSim_overlap_IPDboot_50_2_simul_2.eps", width = 10.4, height = 8.3)
...
#
 ...
 pdf("kmSim_overlap_IPDboot_500_6_simul_2.eps", width = 10.4, height = 8.3)
